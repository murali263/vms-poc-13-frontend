...
@Component({
  selector: 'app-generalvisitortab',
  templateUrl: './generalvisitortab.component.html',
  styleUrls: ['./generalvisitortab.component.css']
})
export class GeneralvisitortabComponent implements OnInit {
 ...
 AdharNumberPattern='Invalid Aadhar Number';
  ...
  buildForm() {
    this.visitorform = this.fb.group({
      ...
      refer_to: [''],
      memberscount: ['',[Validators.required,Validators.minLength(1),Validators.maxLength(99),Validators.pattern('^([1-9][0-9]{0,1}|100)$')]],
      vehicle_number: [''],
      visiting_from: ['',[Validators.required]],
      visit_date: [this.minDate],
      visit_time: [this.time],
      Comment: ['',[Validators.required]],
      visitType:['GeneralVisitor',Validators.required],
      files:[],
