...
@Component({
  selector: 'app-labourertab',
  templateUrl: './labourertab.component.html',
  styleUrls: ['./labourertab.component.css'],
})
export class LabourertabComponent implements OnInit {
  ...
  buildForm() {
    this.visitorform = this.fb.group({
      ...
      visitType: ['Labourer', [Validators.required]],
    });
  }
  createvisitor() {
